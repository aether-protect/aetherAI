...
Aether Protect detects security threats in HTTP requests using an ONNX inference engine with a custom Transformer+CharCNN model.

## Features

- **ONNX Inference**: Fast (~2ms) CPU-optimized threat detection with 14 threat classes
